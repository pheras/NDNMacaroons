...
class SecTpmFileEnc : public SecTpm
{
public:
  ...
  explicit
  SecTpmFileEnc(const std::string& dir = "");
  ...
  virtual void
  getSymmetricKeyFromTpm(const Name&  keyName, std::string& keyBits);


  virtual void
  setSymmetricKeyToTpm(const Name&  keyName, const uint8_t* keybits, size_t key_size);
